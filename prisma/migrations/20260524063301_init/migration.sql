...
-- CreateIndex
CREATE INDEX "transactions_senderWalletId_createdAt_idx" ON "transactions"("senderWalletId", "createdAt");

-- CreateIndex
CREATE INDEX "transactions_receiverWalletId_createdAt_idx" ON "transactions"("receiverWalletId", "createdAt");
